...
/**
 * A command to update the actuator endpoints for an {@link ApplicationInstance application instance}.
 *
 * @author Tim Ysewyn
 */
public final class UpdateActuatorEndpoints {

	private final String id;
	private final Links actuatorEndpoints;

	public UpdateActuatorEndpoints(String id, Links actuatorEndpoints) {
		Assert.notNull(id, "id must not be null!");
		Assert.notNull(actuatorEndpoints, "actuatorEndpoints must not be null!");
		this.id = id;

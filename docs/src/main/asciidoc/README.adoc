...
To learn everything there is to know about the Microservices Dashboard Server, please consult the http://ordina-jworks.github.io/microservices-dashboard/[reference documentation].

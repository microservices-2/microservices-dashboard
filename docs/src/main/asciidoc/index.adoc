...
.Using properties
----
msdashboard.mappings.requestHeaders.headername1=headervalue1
msdashboard.mappings.requestHeaders.headername2=headervalue2
----
| 
...
.Using properties
----
msdashboard.mappings.filteredServices[0]=hystrix
msdashboard.mappings.filteredServices[1]=diskSpace
----
| hystrix, diskSpace, configServer, discovery
|===
...
```
NOTE: You can supply your own jsonPath using properties.

...
GH_URL="https://${GH_TOKEN}@github.com/ordina-jworks/microservices-dashboard.git"
TEMPDIR="$(mktemp -d /tmp/gh-pages.XXX)"

echo "Cloning gh-pages branch..."
git clone --branch gh-pages --single-branch --depth 1 --config user.name="Andreas Evers" --config user.email="krosan@gmail.com" "$GH_URL" "$TEMPDIR"
